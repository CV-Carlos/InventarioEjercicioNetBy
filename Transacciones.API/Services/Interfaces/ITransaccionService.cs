...
namespace Transacciones.API.Services.Interfaces
{
    ...
    {
        Task<IEnumerable<TransaccionDto>> ObtenerTodosAsync(int? productoId, DateTime? fechaInicio, DateTime? fechaFin, string? tipo);
        Task<TransaccionDto?> ObtenerPorIdAsync(int id);
